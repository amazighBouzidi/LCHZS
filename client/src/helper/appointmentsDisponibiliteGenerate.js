export const appointmentsDisponibilite = () => {
    ...
    const generateAppointmentsForDate = (year, month, day) => {
        ...
        while (endHour < 17) {
            ...
            appointments.push({
                startDate: `${year}-${addLeadingZero(month)}-${addLeadingZero(day)}T${addLeadingZero(startHour)}:${addLeadingZero(startMinute)}+01:00`,
                endDate: `${year}-${addLeadingZero(month)}-${addLeadingZero(day)}T${addLeadingZero(endHour)}:${addLeadingZero(endMinute)}+01:00`,
