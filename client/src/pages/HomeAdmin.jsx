...
import { countData } from "../helper/helperUser";
...
export default function HomeAdmin() {
  ...
  const [countAnalysis, setCountAnalysis] = useState(0)
  const [countResultNotValidated, setCountResultNotValidated] = useState(0)
  ...
  useEffect(() => {
	...
	countData()
	.then(({ analyseCount, patientCount, employerCount, notValidatedResultPrescription }) => {
		setCountPatient(patientCount)
		setCountAnalysis(analyseCount)
		setCountEmployer(employerCount)
		setCountResultNotValidated(notValidatedResultPrescription)
	})
        ...
        <ul className="side-menu top">
          <li className={activePage === "/homeAdmin" ? "active" : ""}>
            <a
              onClick={() =>
                navigate("/homeAdmin", {
                  state: { activePage: "/homeAdmin", activeDashboard: test },
                })
              }
            >
          ...
          <li>
            <a
              onClick={() =>
                navigate("/listeEmployers", {
                  state: {
                    activePage: "/listeEmployers",
          ...
          <li className={activePage === "/listeAnalyses" ? "active" : ""}>
            <a
              onClick={() =>
                navigate("/listeAnalyses", {
                  state: {
                    activePage: "/listeAnalyses",
                    activeDashboard: test,
                  },
                })
              }
          ...
          <li
            className={
              activePage === "/validatePrescriptionResults" ? "active" : ""
            }
          >
            <a
              onClick={() =>
          ...
          <li className={activePage === "/medicalFolder" ? "active" : ""}>
            <a
              onClick={() =>
                navigate("/medicalFolder", {
                  state: {
                    activePage: "/medicalFolder",
                    activeDashboard: test,
                  },
                })
              }
            ...
            <a
              onClick={() =>
                navigate("/profileAdmin", {
                  state: { activePage: "/profileAdmin", activeDashboard: test },
                })
              }
            >
      ...
      <section id="content">
        ...
        <main>
          ...
          <ul className="box-info">
            ...
            <li>
              <i className="bx bxs-dollar-circle"><AnalyticsIcon/></i>
              <span className="text">
                <h3>{countAnalysis}</h3>
                <p>analyse</p>
              </span>
			...
			<li>
              <i className="bx bxs-dollar-circle"><TaskIcon/></i>
              <span className="text">
                <h3>{countResultNotValidated}</h3>
                <p>Ordonnance non valider</p>
              </span>
            </li>
          </ul>
