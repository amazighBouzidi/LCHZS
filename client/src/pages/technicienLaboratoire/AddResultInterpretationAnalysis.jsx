...
import FormInterpretationResult from '../../components/technicienLaboratoire/FormInterpretationResult';


export default function AddResultInterpretationAnalysis() {
            ...
            <div className="head-title">
              <div className="left">
                ...
                <ul className="breadcrumb">
                  ...
                  <li>
                    <a className="active">
                      Saisir resultat Analyse du patient
                    </a>
                  </li>
                </ul>
              </div>
