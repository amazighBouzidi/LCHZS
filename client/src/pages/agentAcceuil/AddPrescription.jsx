...
import ProfilePrescription from '../../components/agentAcceuil/ProfilePrescription'
import PatientSelection from '../../components/agentAcceuil/PatientSelection'
import FormPrescription from '../../components/agentAcceuil/FormPrescription'
    ...
    return (
      ...
      <section id="sidebar" className={test === true ? "show" : "hide"}>
          ...
          <ul className="side-menu top">
              ...
              <li className={activePage === '/listePrescriptions' ? 'active' : ''}>
          ...
          <nav>
            ...
            <main>
                      ...
                      <h1>Dashboard</h1>
                        <ul className="breadcrumb">
                            ...
                            <li 
                              ...
                              onClick={() => navigate('/listePrescriptions', {state: { activePage: '/listePrescriptions', activeDashboard: test }})}
                            >
                                <a>
                            ...
                            <li><ChevronRightIcon style={{marginTop: '8px'}} /></li>
                            <li>
                                <a className="active">Ajouter Ordonnance</a>
                            </li>
                        </ul>
                    </div>
                </div>	
                <ul className="box-info">
                    <li>
                        <span className="text" id='divPrescription'>
                          <div id='divPrescription1'>
                            <PatientSelection />
                            <ProfilePrescription user={user} />
                          </div>
                          <div id='divPrescription2'>
                            <FormPrescription />
                          </div>
                        </span>
                    </li>
