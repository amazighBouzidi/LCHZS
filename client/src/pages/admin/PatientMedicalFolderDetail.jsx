...
import ProfileMedicalDetails from '../../components/admin/ProfileMedicalDetails'

export default function PatientMedicalFolderDetail() {
                  ...
                  <div className="left">
                      ...
                      <ul className="breadcrumb">
                          ...
                          <li
                            ...
                            onClick={() => navigate('/medicalFolder', {state: { activePage: '/medicalFolder', activeDashboard: test }})}
                          >
                              <a>Dossier Medical Patients</a>
                          </li>
                          <li><ChevronRightIcon style={{marginTop: '8px'}} /></li>
                          <li>
                              <a className="active">Dossier Medical Patients Details</a>
                          </li>
                      </ul>
                  </div>
              </div>	
