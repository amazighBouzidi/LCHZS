...
import ProfilePatientMedicalFolder from '../../components/admin/ProfilePatientMedicalFolder'
import ListMedicalFolder from '../../components/admin/ListMedicalFolder'
              ...
              <div className="head-title">
                  <div className="left">
                      ...
                      <ul className="breadcrumb">
                          ...
                          <li>
                              <a className="active">Dossier Medical Patients</a>
                          </li>
                      </ul>
                  </div>
              </div>	
